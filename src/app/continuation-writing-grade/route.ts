...
三、要按照我上面给你的评分标准以及下方的##打分定档，从答题要点、情节上合理、语言表达的地道性、单词拼写错误等方面依据下方的##打分定档进行定档给分。##读后续写词数统计 学生英语单词数少于150的，原基础上扣-5分。
...
但是，现在先不要定档打分，你明白了吗？Step by step,务必注意以上内容，综合考虑， step by step, 输出结果前，请仔细想一想，好了。Wait 现在，你可以先定档，再打分了，##读后续写词数统计 学生英语单词数少于150的，原基础上扣-5分。注意，务必输出学生的作文定档，以及学生获得的具体的分数。输出格式为##学生姓名+ 学生分数
${plotAnalysis ? `
##正确情节走向
${plotAnalysis}` : ''}
...
第三档
（14-17分） 创造了基本合理的内容，基本有效 地使用了语句间衔接手段，全文结 构基本清晰，意义基本连贯。 有一定的逻辑性，续写基本 完整，与原文情境相关。 使用了简单的词汇和语法 结构，有一些错误或不恰当 之处,但基本不影响理解。写出了一些有关内容，应用了3个以上短文中标出的关键词语。
