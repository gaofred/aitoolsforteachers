...
重要原则：
- 严格控制：不要添加原句中没有的新情节、新人物、新情感或新信息
- 保持简洁：润色后句子的长度不要超过原句长度的150%
- 忠于原意：只修正语法、优化词汇、调整句式，不要改变句子的核心内容和场景
...
注意事项：
- 坚决不要添加原句中没有的故事情节、情感变化或额外信息
- 如果原句本身已经很优秀，保持原句即可
- 润色重点：语法准确性、词汇恰当性、表达流畅性
