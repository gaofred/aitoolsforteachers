...
export default function QixuanwuVocabularyOrganisePage() {
  ...
  // 工具配置
const toolCost = 2; // 七选五词汇整理消耗2个点数
...
${result.replace(/<[^>]*>/g, '')}`;
    ...
    link.href = url;
    link.download = `七选五词汇整理_${new Date().toISOString().split('T')[0]}.txt`;
  ...
  const handleOrganise = async () => {
    ...
    try {
      const response = await fetch('/api/ai/qixuanwu-vocabulary-organise', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center">
        <div className="animate-pulse text-center">
          ...
          <p className="text-gray-600">正在加载七选五词汇整理工具...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-900">七选五重点词汇整理</h1>
                <p className="text-sm text-gray-500">输入七选五阅读文章，AI将为您整理出重点词汇和核心短语</p>
              </div>
            </div>
            ...
            <Card className="bg-white border-gray-200 shadow-sm">
              <CardHeader>
                <div className="flex items-start gap-3">
                  <div className="w-12 h-12 rounded bg-gradient-to-br from-blue-100 to-blue-50 flex items-center justify-center flex-shrink-0 border border-blue-200">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-600 leading-relaxed">
                      输入一篇七选五阅读文章，AI将为您整理出重点词汇、核心短语和固定搭配，并配上英文例句和对应句子翻译，帮助学生高效掌握七选五阅读材料中的核心词汇。
                    </p>
                      ...
                      <div className="flex items-start space-x-2">
                        ...
                        <div className="text-sm text-red-700">
                          <p className="font-semibold">
                            <span className="text-red-600">重要注意：</span>要带上七个选项，否则会报错。
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Textarea
                      ...
                      placeholder="请粘贴七选五阅读文章内容，建议包含完整的文章正文和题目选项..."
              ...
              <Card className="bg-white border-gray-200 shadow-sm">
                <CardContent className="py-16">
                  <div className="text-center">
                    ...
                    <p className="text-gray-600 mb-4">
                      在左侧输入七选五阅读文章内容，选择整理类型，点击"开始整理词汇"按钮，
                      AI将为您生成详细的词汇整理报告。
                    </p>
