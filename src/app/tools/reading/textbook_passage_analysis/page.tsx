...
export default function TextbookPassageAnalysisPage() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      const response = await fetch('/api/ai/textbook-passage-analysis', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-900">课文文章分析工具</h1>
                <p className="text-sm text-gray-500">专业的课文文章AI分析工具（Coze工作流驱动）</p>
              </div>
            </div>
              ...
              <CardContent className="space-y-4">
                <div>
                  ...
                  <Textarea
                    ...
                    placeholder="在此粘贴英文课文文章内容，或使用拍照识别图片中的文字...
                ...
                <CardContent className="flex items-center justify-center h-[400px]">
                  <div className="text-center space-y-6">
                    ...
                    <div className="relative inline-flex">
                      ...
                      <div className="absolute -top-1 -right-8 w-2 h-2 bg-blue-300 rounded-full animate-bounce" style={{ animationDelay: '1s' }}></div>
                    </div>
                    ...
                    <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 max-w-sm mx-auto">
                      <div className="flex items-center space-x-2 text-blue-700 text-sm">
                        ...
                        <span>AI正在分析课文结构，生成专业的课文解析内容</span>
                      </div>
                    </div>
                  </div>
                </CardContent>
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button
                        ...
                        onClick={() => {
                          ...
                          element.download = 'textbook_passage_analysis.txt'
