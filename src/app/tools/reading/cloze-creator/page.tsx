...
export default function ClozeCreatorPage() {
  ...
  const handleGenerate = async () => {
    ...
    try {
      const response = await fetch('/api/ai/cloze-creator', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      if (data.success) {
        ...
        let errorMessage = data.error || '完形填空生成失败，请稍后重试'
      ...
      console.error('完形填空生成错误:', error)
      alert('完形填空生成失败，请稍后重试')
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-semibold text-gray-900">完形填空命题工具</h1>
                <p className="text-sm text-gray-500">专业的完形填空AI生成工具（Coze工作流驱动）</p>
              </div>
            </div>
...
• 题目难度分析"
          ...
          {/* 右侧：结果区域 */}
          <div className="space-y-6">
            {isGenerating && !clozeResult && (
              <Card className="h-full">
                <CardHeader>
                  <CardTitle className="flex items-center justify-center">
                    <span className="text-green-600">
                      Coze工作流生成完形填空中......大约需要2-3分钟
                    </span>
                  </CardTitle>
                </CardHeader>
                <CardContent className="flex items-center justify-center h-[400px]">
                  <div className="text-center space-y-6">
                    ...
                    <div className="relative inline-flex">
                      <div className="w-16 h-16 bg-gradient-to-br from-green-500 to-blue-600 rounded-full flex items-center justify-center animate-pulse">
                      ...
                      {/* 思维泡泡动画 */}
                      <div className="absolute -top-2 -right-2 w-4 h-4 bg-green-400 rounded-full animate-bounce" style={{ animationDelay: '0s' }}></div>
                      <div className="absolute -top-4 -right-6 w-3 h-3 bg-blue-400 rounded-full animate-bounce" style={{ animationDelay: '0.5s' }}></div>
                      <div className="absolute -top-1 -right-8 w-2 h-2 bg-green-300 rounded-full animate-bounce" style={{ animationDelay: '1s' }}></div>
                    </div>
                    ...
                    <div className="w-64 mx-auto">
                      <div className="h-2 bg-gray-200 rounded-full overflow-hidden">
                        <div className="h-full bg-gradient-to-r from-green-500 to-blue-600 rounded-full animate-pulse"
                             style={{
                               width: '60%',
                    ...
                    <div className="bg-green-50 border border-green-200 rounded-lg p-4 max-w-sm mx-auto">
                      <div className="flex items-center space-x-2 text-green-700 text-sm">
                        ...
                        <span>AI正在分析篇章内容，生成专业的完形填空试题</span>
                      </div>
                    </div>
                  </div>
                </CardContent>
                  ...
                  <CardTitle className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      <Button
                        ...
                        size="sm"
                        onClick={() => {
                          navigator.clipboard.writeText(clozeResult)
                          toast.success('完形填空已复制到剪贴板')
                        }}
                      ...
                      <Button
                        ...
                        onClick={() => {
                          ...
                          const file = new Blob([clozeResult], { type: 'text/plain;charset=utf-8' })
