...
但是，现在先不要定档打分，你明白了吗？Step by step,务必注意以上内容，综合考虑， step by step, 输出结果前，请仔细想一想，好了。Wait 现在，你可以先定档，再打分了，注意，只要情节走向正确，可以考虑15分以上打分。##读后续写词数统计  学生英语单词数少于150的，原基础上扣-5分。注意，务必输出学生的作文定档，以及学生获得的具体的分数。输出格式为##学生姓名+ 学生分数
${plotAnalysis ? `
##正确情节走向
${plotAnalysis}` : ''}
